...
class UpdateReservationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'check_in' => 'nullable|date|after_or_equal:today|before:check_out',
    ...
    public function withValidator(Validator $validator): void
    {
        ...
        $validator->after(function ($validator) use ($roomId, $checkIn, $checkOut, $reservationId) {
            $isRoomReserved = $this->reservationService->isRoomAvailable($roomId, $checkIn, $checkOut, $reservationId);
