...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines (Farsi)
    |--------------------------------------------------------------------------
    */

    'accepted' => 'فیلد :attribute باید پذیرفته شود.',
    'accepted_if' => 'فیلد :attribute زمانی که :other مقدار :value است باید پذیرفته شود.',
    ...
    'ascii' => 'فیلد :attribute فقط باید حاوی نویسه‌های الفبایی-عددی و نمادهای تک‌بایتی باشد.',
    ...
    'declined_if' => 'فیلد :attribute زمانی که :other مقدار :value است باید رد شود.',
    ...
    'missing_if' => 'فیلد :attribute زمانی که :other مقدار :value است نباید ارسال شود.',
    'missing_unless' => 'فیلد :attribute نباید ارسال شود مگر اینکه :other مقدار :value داشته باشد.',
    'missing_with' => 'فیلد :attribute زمانی که :values ارسال شده نباید ارسال شود.',
    'missing_with_all' => 'فیلد :attribute زمانی که :values ارسال شده‌اند نباید ارسال شود.',
    ...
    'password' => [
        ...
        'uncompromised' => 'این :attribute در نشت داده‌ای دیده شده است. لطفاً :attribute دیگری انتخاب کنید.',
    ],
    'present' => 'فیلد :attribute باید ارسال شود.',
    'present_if' => 'فیلد :attribute زمانی که :other مقدار :value است باید ارسال شود.',
    'present_unless' => 'فیلد :attribute باید ارسال شود مگر اینکه :other مقدار :value داشته باشد.',
    'present_with' => 'فیلد :attribute زمانی که :values ارسال شده باید ارسال شود.',
    'present_with_all' => 'فیلد :attribute زمانی که :values ارسال شده‌اند باید ارسال شود.',
    'prohibited' => 'فیلد :attribute ممنوع است.',
    'prohibited_if' => 'فیلد :attribute زمانی که :other مقدار :value است ممنوع است.',
    ...
    'prohibits' => 'فیلد :attribute ارسال :other را ممنوع می‌کند.',
    'regex' => 'فرمت فیلد :attribute نامعتبر است.',
    'required' => 'فیلد :attribute الزامی است.',
    'required_array_keys' => 'فیلد :attribute باید شامل ورودی‌های زیر باشد: :values.',
    'required_if' => 'فیلد :attribute زمانی که :other مقدار :value است الزامی است.',
    ...
    'required_with' => 'فیلد :attribute زمانی که :values ارسال شده الزامی است.',
    'required_with_all' => 'فیلد :attribute زمانی که :values ارسال شده‌اند الزامی است.',
    'required_without' => 'فیلد :attribute زمانی که :values ارسال نشده الزامی است.',
    'required_without_all' => 'فیلد :attribute زمانی که هیچ‌کدام از :values ارسال نشده‌اند الزامی است.',
    ...
    'national_code' => [
        'in_valid' => 'کدملی نامعتبر است.',
    ],

    'attributes' => [
        'id' => 'شناسه',
        'amenity_category_id' => 'دسته بندی امکانات',
        'name' => 'نام',
        'icon' => 'آیکون',
        'city_id' => 'شهر',
        'manager_id' => 'مدیر',
        ...
        'userId' => 'کاربر',
        'room_id' => 'اتاق',
        'reservation_status_id' => 'وضعیت رزرو',
        'payment_status_id' => 'وضعیت پرداخت',
        'check_in' => 'زمان ورود',
        'check_out' => 'زمان خروج',
        'total_price' => 'مبلغ کل',
        'guest_count' => 'تعداد مهمان',
        'hotel_id' => 'هتل',
        'room_status_id' => 'وضعیت اتاق',
        'room_type_id' => 'نوع اتاق',
        'number' => 'شماره',
        'floor' => 'طبقه',
        'capacity' => 'ظرفیت',
